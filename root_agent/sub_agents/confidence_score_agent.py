...
async def inject_session_id_to_state(callback_context: CallbackContext):
    """Automatically grabs the current session ID and puts it into the state."""
    # callback_context.session.id contains the ID generated by the Web UI
    print("============ SESSION ID=====================\n\n")
    print(callback_context.session.id)
...
The current tracking session ID is: {session_id}. Use this session id in the json .
